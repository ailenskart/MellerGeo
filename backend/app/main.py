...
def health():
    ...
    return {
        ...
        "google_maps_live": gstatus.get("google_live", gstatus.get("live", False)),
        "osm_live": gstatus.get("osm_live", False),
        "maps_live_source": gstatus.get("live_source"),
        "maps_live": gstatus.get("live", False),
        "google_api_error": gstatus.get("error") if not gstatus.get("live") else None,
